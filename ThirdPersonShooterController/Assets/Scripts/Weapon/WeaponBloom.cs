...
public class WeaponBloom : MonoBehaviour
{
    ...
    public Vector3 ApplyBloomAngle(Transform barrelPos)
    {
        ...
        Vector3 randomRotateion = new Vector3(randX, randY, randZ);
        return barrelPos.localEulerAngles + randomRotateion;
    }
}
